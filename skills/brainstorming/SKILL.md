...
This applies to every task on every path below — the ceremony scales with
the task; the approval gate never does. The gate exists because
implementing before agreement regularly builds the wrong thing
convincingly; the cost isn't the wasted code, it's the anchoring on it.
If you believe this situation genuinely doesn't need a design pass, say
so and ask — don't skip silently.
</HARD-GATE>
