...
- `tests/claude-code/test-host-integration-policy.sh` — grep assertions pinning the fork's
  host-integration delta (worktree deference, host review commands, the TDD test-path
  exception, repo commit/integration conventions). No LLM; see FORK.md.
